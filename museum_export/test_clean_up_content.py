...
class Test(unittest.TestCase):
    ...
    def test_1_add_missing_required_fields(self):
        ...
        object = {"id": "test"}
        clean_up_content_class = CleanUpContent(object)
        fixed_object = clean_up_content_class._add_missing_required_fields(object)
    ...
    def test_2_define_worktype(self):
        ...
        clean_up_content_class = CleanUpContent(object)
        fixed_object = clean_up_content_class._define_worktype(object)
    ...
    def test_3_remove_bad_subjects(self):
        ...
        clean_up_content_class = CleanUpContent(object)
        fixed_object = clean_up_content_class._remove_bad_subjects(object)
    ...
    def test_4_fix_creators(self):
        """ test _fix_creators """
        object = {"id": "test", "creators": [{"fullName": "test name"}]}
        clean_up_content_class = CleanUpContent(object)
        fixed_object = clean_up_content_class._fix_creators(object)
    ...
    def test_5_fix_modified_date(self):
        ...
        clean_up_content_class = CleanUpContent(object)
        fixed_object = clean_up_content_class._fix_modified_date(object)
