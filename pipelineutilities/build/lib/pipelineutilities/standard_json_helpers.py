...
def _clean_up_standard_json_strings(standard_json: dict) -> dict:
    ...
    if 'createdDate' in standard_json:
        standard_json['createdDate'] = _remove_brackets(standard_json['createdDate'])
    if 'modifiedDate' in standard_json:
        standard_json['modifiedDate'] = _remove_brackets(standard_json['modifiedDate'])
